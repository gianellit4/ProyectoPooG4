...
public class CrearEmpleadoG extends javax.swing.JFrame {
    ...
    public CrearEmpleadoG(Hotel hot, Administrador admi)
    {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.jRadioButton1.isSelected())
        {
            ...
            else
            {
                ...
                Administrador ref = new Administrador(usuario, contraseña, DNI, nombre, apellido, rol);
                //INGRESAR AL ARREGLO
                Adm.crearEmpleado(hotel, ref);
                CargarTabla();
            }
        ...
        else if(this.jRadioButton2.isSelected())
        {
            ...
            Recepcionista ref = new Recepcionista(usuario, contraseña, DNI, nombre, apellido, rol);
            //INGRESAR AL ARREGLO
            Adm.crearEmpleado(hotel, ref);
            CargarTabla();
        }
